...
def create_cifar_resnet18():
    """Builds a CIFAR-10 adapted ResNet-18 (standard 3x3 conv1, no initial maxpool)."""
...
def train(args):
    ...
    model = create_cifar_resnet18().to(device)
...
def main():
    ...
    parser.add_argument("--log-dir", type=str, default="ml/logs", help="Directory for JSON run logs")
