...
from ml.sparsity_prediction.models.resnet50 import get_cifar_resnet50
from ml.sparsity_prediction.models.vit import get_cifar_vit_tiny
from ml.sparsity_prediction.models.gpt import get_gpt_tiny
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="ml/sparsity_prediction/logs", help="Output directory")
